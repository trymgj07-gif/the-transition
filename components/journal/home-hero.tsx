...
import { PremiumButton } from "@/components/landing/button";

export function HomeHero() {
  return (
    <section className="relative flex min-h-[100svh] items-center justify-center px-6 pt-28 pb-24 md:px-8">
      <motion.div
      ...
      >
        ...
        >
          <PremiumButton href="#featured">Read the latest</PremiumButton>
          <PremiumButton href="#writing" variant="outline">
            Explore writing
          </PremiumButton>
        </motion.div>
      </motion.div>
